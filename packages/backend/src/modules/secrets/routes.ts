...
const PROVIDERS = [
  ...
  { id: 'aws', name: 'AWS', keys: ['aws_access_key_id', 'aws_secret_access_key', 'aws_region'] },
  { id: 'gcloud', name: 'Google Cloud', keys: ['gcloud_service_account_json'] },
  { id: 'azure', name: 'Microsoft Azure', keys: ['azure_tenant_id', 'azure_client_id', 'azure_client_secret', 'azure_subscription_id'] },
